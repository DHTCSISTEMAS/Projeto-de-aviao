...
import com.example.dv.myskyairlines.Adapter.FlightAdapter;
import com.example.dv.myskyairlines.Model.Flight;
import com.example.dv.myskyairlines.databinding.ActivitySearchBinding;
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    for (DataSnapshot issue : snapshot.getChildren()) {
                        ...
                        //To filter with date, uncomment below and comment top line
                        /*
